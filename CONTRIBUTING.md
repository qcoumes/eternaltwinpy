...
`eternaltwinpy` could always use more documentation, whether as part of the
official `eternaltwinpy` docs, in docstrings, or even on the web in blog
...
2. Commit your changes and push your branch to GitHub:
    ...
    We favor the [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) format.
